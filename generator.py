...
class ColorizationCNN(nn.Module):
    def __init__(self):
        ...
        self.batchNorm2   = nn.BatchNorm2d(num_features=2)
    ...
    def forward(self, LComponent):
        ...
        layer10 = self.leakyReLU(layer10)
        ...
        layer11 = self.leakyReLU(layer11)
        ...
        layer12 = self.leakyReLU(layer12)
        ...
        layer13 = self.leakyReLU(layer13)
        ...
        layer14 = self.leakyReLU(layer14)
        # Add residuals from Layer 1_1
        layer14 = torch.cat((layer14, layer1_1), dim=1)


        # Layer 15: [256,256,64] -> [256,256,2]
        layer15 = self.conv15(layer14)
        layer15 = self.batchNorm2(layer15)

        # Layer 16: [256,256,2] -> [256,256,3]
        layer16 = torch.cat((layer15, LComponent), dim=1)

        # Layer 17: [256,256,3] -> [256,256,2]
